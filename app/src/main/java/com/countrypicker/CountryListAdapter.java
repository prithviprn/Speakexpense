...
public class CountryListAdapter extends BaseAdapter {
    ...
    private int getResId(String drawableName) {
        ...
        try {
            Class<com.speakexpense.R.drawable> res = com.speakexpense.R.drawable.class;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            cell = new Cell();
            cellView = inflater.inflate(com.speakexpense.R.layout.row, null);
            cell.textView = (TextView) cellView.findViewById(com.speakexpense.R.id.row_title);
            cell.imageView = (ImageView) cellView.findViewById(com.speakexpense.R.id.row_icon);
