...
public class Linechart extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Main.class);
                Linechart.this.startActivity(intent);
            }
        });
        id.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, AddExpenses.class);
                Linechart.this.startActivity(intent);
            }
        });
        dd.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, DeleteExpenses.class);
                Linechart.this.startActivity(intent);
            }
        });
        ud.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, UpdateExpenses.class);
                Linechart.this.startActivity(intent);
            }
        });
        ...
        settings.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Set.class);
                Linechart.this.startActivity(intent);
            }
        });
        ...
        viewdb.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Displaydatabase.class);
                Linechart.this.startActivity(intent);
            }
        });
        searchexp.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Searchform.class);
                Linechart.this.startActivity(intent);
            }
        });
        viewcsv.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Csvfiles.class);
                Linechart.this.startActivity(intent);
            }
        });
        bar.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Graph.class);
                Linechart.this.startActivity(intent);
            }
        });
        line.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Linechart.class);
                Linechart.this.startActivity(intent);
            }
        });
        piechart.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Linechart.this, Piechart.class);
                Linechart.this.startActivity(intent);
            }
        });
        ...
        //drawing bar chart
        mChart = ChartFactory.getLineChartView(Linechart.this, dataset, multiRenderer);
